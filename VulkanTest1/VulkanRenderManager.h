...
namespace te
{
    ...
    private:
        ...
        // необходино дл€ взаимодестви€ с драйвером физического устройства
        vk::Device device;
        ...
        //-------------------------------------------- синхронизаци€ двойной буферизации------------------------------

        //семафора дл€ синхронизации (ожидани€ пока изображение не доступно)
        std::vector<vk::Semaphore> imageAvailableSemaphores;
        //семафора дл€ синхронизации (ожидани€ пока операции рендеринга не окончены)
        ...
        //очередь команд дл€ вычислени€ елементов графики
        ...
        //презентационна€ очередь дл€ отображени€ на поверхность  SurfaceKHR
        ...
        //текущий номер фрейма в spawChain (двойна€-тройна€ буферизаци€)
        ...
        //инициализаци€ библиотеки вулка
        void createInstance();
        //установка дебагера дл€ вулкана
        void setupDebugMessenger();
        //создание полотна на котором будет производитьс€ рендеринга
        void createSurface();

        //выбор физитеского устройства GPU
        void pickPhysicalDevice();

        //создание логического устройсива вулка дл€ взаимодействи€ с драйвером устройства
        void createLogicalDevice();


        //настройка структуры дл€ прохода рендеринга (настройка цвета, глубины изображени€)
        void createRenderPass();

        //создание прив€зки данных к шейдерам (vertex, fragment)
        void createDescriptorSetLayout();

        //определение всех этапов отрисовки изображени€
        ...
        //создание пула дескрипторов дл€ пайплана
        ...
        //перестройка ципочки обновлений (двойна€-тройна€ буферизаци€) после изменени€ размеров окна
        void recreateSwapChain();

    public:


        //выделение вертесного буфера и получение дискриптора пан€ти
        void createVertexBuffer(std::vector<te::Vertex> indices, vk::Buffer& vertexBuffer, vk::DeviceMemory& vertexBufferMemory);

        //выделение индесного буфера и получение дискриптора пан€ти
