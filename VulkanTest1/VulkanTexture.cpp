...
//        bool forceLinear) : filename(filename), format(format),
//                            device(device), copyQueue(copyQueue),
//                            imageUsageFlags(imageUsageFlags), imageLayout(imageLayout)
//    {
//
//    }
//
...
//	}
//
//	TextureData Texture::loadFromFile(std::string filename)
//	{
//        TextureData textureData{};
//        stbi_uc* pixels = stbi_load(filename.c_str(), &textureData.texWidth, &textureData.texHeight, &textureData.texChannels, STBI_rgb_alpha);
//        vk::DeviceSize imageSize = textureData.texWidth * textureData.texHeight * 4;
//        mipLevels = static_cast<uint32_t>(std::floor(std::log2(std::max(textureData.texWidth, textureData.texHeight)))) + 1;
//
//        if (!pixels) {
...
//            stagingBuffer, stagingBufferMemory, device->physicalDevice, device->logicalDevice);
//
//        void* data;
...
//	}
//
//	void Texture::createTextureImage(TextureData data)
//	{
//
//
//        createImage(
//            data.texWidth, data.texHeight, mipLevels,
