...
void te::VulkanRenderManager::createImageViews()
{
...
void te::VulkanRenderManager::updateUniformBuffer(uint32_t currentImage)
{
    ...
    float deltaX = te::InputManager::getMouseDeltaX();
    float deltaY = te::InputManager::getMouseDeltaY();
...
void te::VulkanRenderManager::endSingleTimeCommands(VkCommandBuffer commandBuffer)
{
...
void te::VulkanRenderManager::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size)
{
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
VkCommandBuffer te::VulkanRenderManager::beginSingleTimeCommands()
{
    VkCommandBufferAllocateInfo allocInfo{};
    allocInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
    allocInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
...
void te::VulkanRenderManager::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory)
{
...
VkImageView te::VulkanRenderManager::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags, uint32_t mipLevels)
{
...
void te::VulkanRenderManager::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo)
{
    createInfo = {};
...
bool te::VulkanRenderManager::isDeviceSuitable(VkPhysicalDevice device)
{
...
QueueFamilyIndices te::VulkanRenderManager::findQueueFamilies(VkPhysicalDevice device)
{
...
SwapChainSupportDetails te::VulkanRenderManager::querySwapChainSupport(VkPhysicalDevice device)
{
...
VkSurfaceFormatKHR te::VulkanRenderManager::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats)
{
...
bool te::VulkanRenderManager::checkDeviceExtensionSupport(VkPhysicalDevice device)
{
...
VkPresentModeKHR te::VulkanRenderManager::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes)
{
...
VkExtent2D te::VulkanRenderManager::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities)
{
...
VkFormat te::VulkanRenderManager::findDepthFormat()
{
...
uint32_t te::VulkanRenderManager::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties)
{
...
VkFormat te::VulkanRenderManager::findSupportedFormat(const std::vector<VkFormat>& candidates, VkImageTiling tiling, VkFormatFeatureFlags features)
{
...
void te::VulkanRenderManager::createImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory)
{
...
VkShaderModule te::VulkanRenderManager::createShaderModule(const std::vector<char>& code)
{
...
std::vector<char> te::VulkanRenderManager::readFile(const std::string& filename)
{
