...
void te::VulkanRenderManager::createTextureImage(VkImage& textureImage, uint32_t& mipLevels)
{
    ...
    te::vk::VulkanHelper::createBuffer(imageSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, stagingBuffer, stagingBufferMemory, physicalDevice, device);
...
void te::VulkanRenderManager::createUniformBuffers()
{
    ...
    for (size_t i = 0; i < swapChainImages.size(); i++) {
        te::vk::VulkanHelper::createBuffer(bufferSize, VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, uniformBuffers[i], uniformBuffersMemory[i], physicalDevice, device);
    }
}
